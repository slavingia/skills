...
| **Processize** | `/processize` | Turning a manual service into a repeatable workflow before delegation or automation |
...
3. **Build** — Ship a manual process that creates value
4. **Processize** — Turn repeated work into a system before automating it
